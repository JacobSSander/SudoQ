 ...
 *
 * @param <T> der Typ der konkret umgewandelt werden soll
 */
public abstract class XmlHandler<T extends Xmlable>
{
	 ...
	 * in eine XML Datei.
	 *
	 * @param obj Objekt, das Xmlable implementiert
	 * @see Xmlable
	 * @throws IllegalArgumentException Wird geworfen, falls das übergebene Objekt null ist
	 */
	 ...
	 *
	 * @param obj leeres Objekt, das Xmlable implementiert
	 ...
	 *
	 * @param tree der Ursprüngliche Baum
	 */
	 ...
	 * zurueck
	 *
	 * @param obj das zu speichernde/ladende Objekt
