...
public class XmlTree implements Iterable<XmlTree>
{
	 ...
	 *
	 * @param name Name der Wurzel Xml Baumes
	 * @throws IllegalArgumentException Wird geworfen, falls der übergebene String null oder leer ist
	 */
	 ...
	 *
	 * @param name Name der Wurzel Xml Baumes
	 * @param content Inhalt des Xml Objektes
	 * @throws IllegalArgumentException Wird geworfen, falls einer der übergebenen Strings null oder der name leer ist
	 */
	 ...
	 *
	 * @param name Name des Attributes dessen Wert erfragt wird.
	 * @return Wert des Attributes oder null, falls das Attribut nicht existiert.
	 * @throws IllegalArgumentException Wird geworfen, falls der übergebene Name null ist
	 */
	 ...
	 *
	 * @param child Anzufügendes Unterobjekt
	 * @throws IllegalArgumentException Wird geworfen, falls der übergebene XmlTree null ist
	 */
	 ...
	 *
	 * @param attribute Anzfügendes Attribut
	 * @throws IllegalArgumentException Wird geworfen, falls der übergebene XmlTree null ist
	 */
