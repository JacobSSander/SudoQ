...
public final class FileManager
{
	 ...
	 *
	 * @param p Ein Ordner fuer die Profile
	...
	/**
	 * Setzt die id des aktuellen Profils für den FileManager, sodass die Pfade zur Verfügung stehen
	 *
	 ...
	 * @throws IOException falls etwas nicht gelöscht werden konnte
	 */
	...
	/**
	 * Gibt die Anzahl der aktuell existierenden Profile zurück (macht keine Rechenfehler :-)
	 *
	 ...
	 *
	 * @param id die id des Profils dessen xml gesucht ist
	...
	/**
	 * Erstellt die Ordnerstruktur und nötige Dateien für das Profil mit der übergebenen ID
	 *
	 ...
	 *
	 * @param id die id des zu löschenden Profils
	 */
	 ...
	 *
	 * @return File, welcher auf das Game-Verzeichnis des aktuellen Profils zeigt
	 */
	...
	/**
	 * Loescht falls existierend das Spiel mit der gegebenen id des aktuellen Profils
	 *
	 * @param id die id des zu loeschenden Spiels
	 ...
	 *
	 * @param gameID The ID of the game whos thumbnail is requested.
	 * @return The thumbnail File.
	 */
	public static File getGameThumbnailFile(int gameID)
	{
		return new File(getGamesDir() + File.separator + "game_" + gameID + ".png");
	}
	 ...
	 *
	 * @param t der gesuchte SudokuTyp
	 * @param c die gesuchte Sudoku Schwierigkeit
	 * @return die Anzahl
	 */
	 ...
	 *
	 * @param sudoku das zu speichernde Sudoku
	 ...
	 *
	 * @param sudoku das zu loeschnde Sudoku
	 */
	 ...
	 *
	 * @param type der Typ des Sudokus
	 * @param complexity die Schwierigkeit des Sudokus
	...
	/**
	 * Gibt den die Sudokus mit den gegebenen Parametern enthaltennden Ordner zurueck
	 *
	 * @param type der Typ des Sudokus
	 * @param complexity die Schwierigkeit des Sudokus
	 * @return der Ordner
	 ...
	 *
	 * @param s das einzuordnende Sudoku
	 * @return den Ordner
	 */
	...
	/**
	 * Erzeugt falls noetig alle Sudoku Ordner fuer die Typen und Schwierigkeiten
	 */
