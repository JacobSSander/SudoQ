...
public class Profile extends ObservableModelImpl<Profile> implements Xmlable
{
	 ...
	 *
	 * @param profileID Die ID des Profils, zu dem gewechselt werden soll.
	 *
	 * @return boolean true, falls die Änderung erfolgreich war, false andernfalls
	 */
...
//		this.gameSettings.setGestures(false);
	 ...
	 * andernfalls -1.
	 *
	 * @return Die ID des aktuellen Spiels. -1, wenn es kein aktuelles Spiel gibt.
	 */
	 ...
	 *
	 * @param id die id des nun aktuellen Spiels
	 */
	 ...
	 *
	 * @return Ein AssistanceSet, welches die im Profil aktivierten Hilfestellungen repräsentiert
	 */
	 ...
	 *
	 * @return true, falls die Gesteneingabe im aktuellen Profil aktiv ist, false andernfalls
	 */
	 ...
	 * Wert.
	 *
	 * @param value true, falls Gesten gesetzt werden sollen, false falls nicht
	 */
	 ...
	 *
	 * @param assistance Assistance, welche gesetzt werden soll
	 * @param value true um die Assistance anzuschalten, sonst false
	 */
	public void setAssistance(Assistances assistance, boolean value)
	{
		if(value)
		{
			this.gameSettings.setAssistance(assistance);
		}
		else
		{
			this.gameSettings.clearAssistance(assistance);
		}
		// notifyListeners(this);
	}
	 ...
	 * false zurückgegeben.
	 *
	 * @param asst Die Hilfestellung von der überprüft werden soll, ob sie im aktuellen Profil aktiviert ist
	...
	/**
	 * Setzt den Wert der gegebenen Statistik für dieses Profil auf den gegebenen Wert
	 *
	 * @param stat die zu setzende Statistik
	 * @param value der einzutragende Wert
	 */
	 ...
	 * null zurückgegeben.
	 *
	 * @param stat Die Statistik, dessen Wert abgerufen werden soll
	 * @return Der Wert der spezifizierten Statistik als String, oder null falls diese ungültig ist
	 */
