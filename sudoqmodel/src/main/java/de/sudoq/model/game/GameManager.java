...
public class GameManager
{
	 ...
	 * @param complexity Die Schwierigkeit des Spiels
	 * @param assists Die für dieses Game zu setzen Assistances
	 * @return Das neue Spiel
	 * @throws IllegalArgumentException falls gameType invalid ist.
	 * @see SudokuTypes
	 * @see Complexity
	 * @see Game
	 */
	 ...
	 * @throws IllegalArgumentException falls keine Spiel mit der entsprechenden id existiert
	 */
	 ...
	 *
	 * @param game Das zu speichernde Game.
	 */
	 ...
	 * sein.
	 *
	 * @throws IllegalStateException Falls die Liste inkonsistent ist
	 */
