...
public class GameData implements Comparable<GameData>
{
	 ...
	 * @param playedAt das Datum als es zuletzt gespielt wurde
	 * @param finished ob es beendet ist
	 * @param type der Typ des zugehörigen Sudokus
	 * @param complexity die Schwierigkeit des zugehörigen Sudokus
	 * @throws IllegalArgumentException falls playedAt null ist oder nicht zu einem Datum parsebar ist
	 */
