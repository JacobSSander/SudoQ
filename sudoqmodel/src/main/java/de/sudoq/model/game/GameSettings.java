...
public class GameSettings implements Xmlable
{
	 ...
	 *
	 * @param assistance Die Hilfestellung die gesetzt werden soll
	 */
	 ...
	 * null, so wird nichts getan.
	 *
	 * @param assistance Die Hilfestellung die gelöscht werden soll
	 */
	 ...
	 *
	 * @param assistance Die Hilfestellung die abgefragt werden soll
	 * @return true, falls die Hilfestellung gesetzt ist, false falls nicht oder falls das Assistance null ist
	 */
	 ...
	 *
	 * @param representation String Repräsentation der Hilfestellungen
	 *
	 * @throws IllegalArgumentException Wird geworfen, wenn aus dem angegebenen String kein AssistanceSet generiert werden kann.
	 */
