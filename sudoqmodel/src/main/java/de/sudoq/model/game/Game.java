...
public class Game implements Xmlable
{
	 ...
	 *
	 * @param id id dieses Spiels
	 * @param sudoku Das Sudoku, das bespielt werden soll
	 * @throws IllegalArgumentException Wird geworfen, falls das übergebene Sudoku null ist
	 */
	 ...
	 *
	 * @param time Die hinzuzufügende Zeit
	 */
	 ...
	 *
	 * @param cell Das Field, welches modifiziert wurde
	 */
	 ...
	 * IllegalArgumentException geworfen.
	 *
	 * @param ate das ActionTreeElement in dessen Zustand das Sudoku überführt werden soll
	 * @throws IllegalArgumentException Wird geworfen, falls das übergebene ActionTreeElement null ist
	 */
	 ...
	 *
	 * @param ate das zu überprüfende ActionTreeElement
	 ...
	 * @throws IllegalArgumentException Wird geworfen, falls das spezifizierte BitSet null ist
	 */
	 ...
	 *
	 * @param assist Die Hilfestellung, welche auf Verfügbarkeit geprüft werden soll
	...
	public void fillFromXml(XmlTree xmlTreeRepresentation)
	{
		...
		for(XmlTree sub : xmlTreeRepresentation)
		{
			if(sub.getName().equals("action"))
			{
				...
				{
					this.stateHandler.addAndExecute(new SolveActionFactory().createAction(f.getCurrentValue() + diff, f));
				}
