...
public class Cell extends ObservableModelImpl<Cell>
{
	...
	private void setCurrentValueP(int value, boolean notify)
	{
		if(isEditable())
		{
			...
			{
				throw new IllegalArgumentException("maxValue is " + maxValue + " parameter value is " + value);
			}
	 ...
	 *
	 * @param value the note to toggle
	 */
	...
	public boolean equals(Object obj)
	{
		if(obj != null && obj instanceof Cell)
		{
			...
			return this.id == other.id &&
					...
					this.noticeFlags.equals(other.noticeFlags);
		}
		return false;
	}
