...
public class ActionTree extends ObservableModelImpl<ActionTreeElement> implements Iterable<ActionTreeElement>
{
	...
	public InsertStrategy getLastInsertStrategy()
	{
		return lastStrategy;
	}
	 ...
	 * @param mountingElement Das Element unter dem die Aktion eingehangen werden soll. Es wird NICHT überprüft, ob dieses Teil des Baums ist
	 * @return Das neue Element, das die gegebene Aktion enthält.
	 * @throws IllegalArgumentException Wird geworfen, falls eines der übergebenen Attribute null ist (ausser der Baum ist noch leer, dann darf mountingElement null sein)
	 */
	 ...
	 * @return den Weg
	 * @throws NullPointerException falls start oder end null sind
	 */
