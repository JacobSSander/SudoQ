...
public class ActionTreeIterator implements Iterator<ActionTreeElement>
{
	 ...
	 *
	 * @param tree Der ActionTree über den iteriert werden soll
	 * @throws IllegalArgumentException Wird geworfen, falls der übergebene ActionTree null ist
	 */
	 ...
	 *
	 * @throws UnsupportedOperationException Wird immer geworfen, da nicht unterstützt
	 */
	public void remove()
	{
