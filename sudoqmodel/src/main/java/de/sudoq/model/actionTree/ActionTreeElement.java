		...
		Iterable<ActionTreeElement>
{
	 ...
	 *
	 * @param id Die eindeutige ID für dieses Element
	 * @param action die diesem ActionTreeElement zugrundeliegende Aktion
	 * @param parent Das Elternelement
	 * @throws IllegalArgumentException Wird geworfen, falls die ID ungültig oder die Action null ist.
	 */
	 ...
	 *
	 * @param child das hinzuzufuegende Kindelement
	 */
