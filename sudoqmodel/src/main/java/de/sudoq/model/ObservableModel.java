...
public interface ObservableModel<T>
{
	 ...
	 * benachrichtigt.
	 *
	 * @param obj Das Objekt, das sich geaendert hat.
	 */
	 ...
	 *
	 * @param listener Das einzutragenden Objekt
	 * @throws IllegalArgumentException Wird geworfen, falls der übergebene Listener null ist
	 */
	 ...
	 *
	 * @param listener Das zu entfernende Objekt.
	 */
