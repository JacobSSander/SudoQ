...
public class DerivationBlock
{
	 ...
	 *
	 * @param block Das Constraint, welches von diesem DerivationBlock als für einen Lössungsschritt relevant repräsentiert werden soll
	 * @throws IllegalArgumentException Wird geworfen, falls das spezifizierten Constraint null ist
	 */
	...
	/**
	 * Diese Methode gibt das Constraint zurück, welches diesem DerivationBlock zugewiesen wurde.
	 *
