...
public class Solution
{
	...
	/**
	 * Die Action, die das zu dieser Solution gehörige Feld löst oder null, falls diese Solution kein Feld löst
	 */
	private Action action;
	
	/**
	 * Eine Liste von SolveDerivations, die die Herleitung für die Action repräsentieren
	 */
	...
	/**
	 * Diese Methode setzt die Action dieses Solution-Objektes auf die spezifizierte. Ist diese null, so wird nichts geändert.
	 *
	 * @param action Die Action, die diesem Solution-Objekt zugewiesen werden soll
	 */
	 ...
	 *
	 * @param derivation Die SolveDerivation, die diesem Solution-Objekt hinzugefügt werden soll
	 */
	 ...
	 *
	 * @return Einen Iterator, mit dem über die SolveDerivations dieses Solution-Objektes iteriert werden kann
	 */
	...
	public List<SolveDerivation> getDerivations()
	{
		return derivations;
	}
}
