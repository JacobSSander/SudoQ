...
public class DerivationCell
{
	 ...
	 *
	 * @param pos Die Position des Feldes, dessen Kandidaten dieses DerivationField repräsentieren soll
	 * @param relevantCandidates Die für den zugehörigen Lösungsschritt relevanten Kandidaten des Feldes an der angegebenen Position
	 * @param irrelevantCandidates Die in der Kandidatenliste vorhandenen, aber für den Lösungsschritt irrelevanten Kandidaten des Feldes an der angegebenen Position
	 * @throws IllegalArgumentException Wird geworfen, falls einer der Parameter null ist
	 */
	...
	/**
	 * Diese Methode gibt die Position des Sudoku-Feldes zurück, auf dass sich dieses DerivationField bezieht.
	 *
	 * @return Die Position des Feldes, auf das sich dieses DerivationField bezieht
	 */
	 ...
	 *
	 * @return Einen Klon des BitSets, welches die relevanten Kandidaten des zugehörigen Feldes für den Lösungsschritt repräsentiert
	 */
	 ...
	 * zurück.
	 *
	 * @return Einen Klon des BitSets, welches die in der Kandidatenliste vorhandenen, aber für den Lösungsschritt irrelevanten Kandidaten des zugehörigen Feldes repräsentiert
	 */
