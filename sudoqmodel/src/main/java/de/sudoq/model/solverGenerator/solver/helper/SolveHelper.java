...
public abstract class SolveHelper
{
	 ...
	 *
	 * @param sudoku sudoku to find a helper for. Mustn't be null
	 * @param complexity desired complexity for the final sudoku. Must be {@code >= 0}.
	 */
	 ...
	 *
	 * @param buildDerivation Bestimmt, ob eine Herleitung erstellt werden soll, welche durch die getDerivation-Methode abgerufen werden kann oder nicht
