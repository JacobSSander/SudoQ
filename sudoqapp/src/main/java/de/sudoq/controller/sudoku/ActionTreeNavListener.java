...
public interface ActionTreeNavListener
{
	 ...
	 *
	 * @param ate ActionTreeElement, welches der Nutzer angewählt hat
	 * @throws IllegalArgumentException Wird geworfen, falls das übergebene ActionTreeElement null ist
	 */
	void onHoverTreeElement(ActionTreeElement ate);
	
	/**
	 * Wird aufgerufen, wenn der Stand eines ausgewählten ActionTreeElementes
	 * geladen werden soll.
	 *
	 * @param ate Wom Benutzer ausgewähltes ActionTreeElement
	 * @throws IllegalArgumentException Wird geworfen, falls das übergebene ActionTreeElement null ist
	 */
	void onLoadState(ActionTreeElement ate);
}
