...
public class CellViewPainter
{
	 ...
	 *
	 * @param canvas Das Canvas, welches bemalt werden soll
	 * @param cell Das Feld, anhand dessen Animation-Einstellung das Canvas bemalt werden soll
	 * @param symbol Das Symbol das gezeichnet werden soll
	 * @param justText Definiert, dass nur Text geschrieben wird
	 * @param darken Verdunkelt das Feld
	 */
	public void markCell(Canvas canvas, View cell, String symbol, boolean justText, boolean darken)
	{
		...
		catch(NullPointerException e)
		{
			/*
				...
				at de.sudoq.view.controlpanel.VirtualKeyboardButtonView.onDraw (VirtualKeyboardButtonView.java:104)
	 ...
	 *
	 * @param canvas Das Canvas
	 * @param cell Das Field, das gezeichnet wird
	 * @param color Die Hintergrundfarbe
	 * @param round Gibt an, ob die Ecken rund gezeichnet werden sollen
	 * @param darken Gibt an, ob das Feld verdunkelt werden soll
	 */
	 ...
	 * @param round Gibt an, ob die Ecken rund gezeichnet werden sollen
	 * @param darken determines whether the cell should be darkened
	 */
	 ...
	 *
	 * @param canvas Das Canvas
	 * @param cell The cell on which to draw
	 * @param color Die Farbe des Textes
	 * @param bold Definiert, ob der Text fett ist
	 * @param symbol Das Symbol, welches geschrieben wird
	 */
	 ...
	 *
	 * @param cell The cell for which the animation is to be stored
	 * @param marking Die Animation die eingetragen werden soll
	 */
