...
public class UserInteractionMediator implements OnGesturePerformedListener, InputListener, CellInteractionListener, ObservableActionCaster
{
	 ...
	 *
	 * @param virtualKeyboard Das virtuelle Keyboard, auf dem der Benutzer Eingaben vornehmen kann
	 * @param sudokuView Die View des Sudokus
	 * @param game Das aktuelle Spiel
	 * @param gestureOverlay Die Gesten-View auf der der Benutzer Gesten eingeben kann
	 * @param gestureStore Die Bibliothek der Gesten
	 */
	public UserInteractionMediator(VirtualKeyboardLayout virtualKeyboard, SudokuLayout sudokuView, Game game, GestureInputOverlay gestureOverlay, GestureStore gestureStore)
	{
	 ...
	 * angezeigt.
	 *
	 * @param activated Gibt den zu setzenden Zustand an
	 */
	 ...
	 *
	 * @param overlay GestureOverlay, auf welchem die Geste eingegeben wurde
	 * @param gesture Geste, die der Benutzer eingegeben hat
	...
	public void restrictCandidates()
	{
		...
		if(this.game.isAssistanceAvailable(Assistances.markSolvedSymbols))
		{
	 ...
	 * caution
	 */
	private synchronized Set<Integer> getRestrictedSymbolSet(Sudoku s, Cell currentCell, boolean noteMode)
	{
	...
	/*
	 * compute the symbols that the keyboard offers if `mark solved symbols`
