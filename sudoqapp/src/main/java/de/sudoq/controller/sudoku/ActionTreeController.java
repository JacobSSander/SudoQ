...
public class ActionTreeController implements ActionTreeNavListener, ModelChangeListener<ActionTreeElement>
{
	 ...
	 *
	 * @param context Kontext, von welchem der ActionTreeController verwendet werden soll
	 * @throws IllegalArgumentException Wird geworfen, falls der übergebene Context null ist
	 */
	 ...
	 *
	 * @param root Das Ausgangselement
	 * @param x Die Position des Elements in x-Richtung
	 * @param y Die Position des Elements in y-Richtung
	 ...
	 *
	 * @param fromX Startposition x-Richtung
	 * @param fromY Startposition y-Richtung
	 * @param toX Endposition x-Richtung
	 * @param toY Endposition y-Richtung
	 */
	 ...
	 *
	 * @param show true falls der Baum sichtbar sein soll false falls nicht
	 */
