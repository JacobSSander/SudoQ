...
public class HintPainter
{
	...
	public void realizeHint(SolveDerivation sd)
	{
		...
		{
			case LastDigit:
				v = new LastDigitView(context, sl, sd);
				break;
			
			case LastCandidate:
				v = new LastCandidateView(context, sl, sd);
				break;
			
			case LeftoverNote:
				v = new LeftoverNoteView(context, sl, (LeftoverNoteDerivation) sd);
				break;
			...
			case NakedQuadruple:
			case NakedQuintuple:
				v = new NakedSetView(context, sl, (NakedSetDerivation) sd);
				break;
			...
			case HiddenQuintuple:
				v = new HiddenSetView(context, sl, (HiddenSetDerivation) sd);
				break;
			
			case LockedCandidatesExternal:
				v = new LockedCandidatesView(context, sl, (LockedCandidatesDerivation) sd);
				break;
			
			case XWing:
				v = new XWingView(context, sl, (XWingDerivation) sd);
				break;
			
			case NoNotes:
				v = new NoNotesView(context, sl, (NoNotesDerivation) sd);
				break;
		}
		if(v != null)
		{
