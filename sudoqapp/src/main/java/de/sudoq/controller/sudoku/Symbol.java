...
public class Symbol implements Iterable<Integer>
{
	 ...
	 *
	 * @param mapping Das zu setzende Mapping
	 */
	 ...
	 * @throws IllegalArgumentException wenn das Symbol noch nicht initialisiert wurde.
	 */
	...
	/**
	 * Erstellt eine neue Instanz des Symbols und setzt den zu verwendenden Symbolsatz.
	 *
	 * @param mapping Den Symbolsatz, der verwendet werden soll. Einige sind als statische Felder im Symbol verfügbar.
	 */
	...
	/**
	 * Diese Methode gibt das gemappte Symbol zurueck, dass von der View gezeichnet wird.
	 *
	 * @param abstractSymbol die interne id/Repräsentation des Symbols
	 ...
	 *
	 * @param symbol Das Symbol als String.
