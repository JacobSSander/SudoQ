...
public class Utility
{
	...
	public static String getGender(Context context, ConstraintShape cs)
	{
	...
	public static String gender2AccDeterminer(Context context, String gender)
	{
		...
		{
			case "m":
				return context.getString(R.string.maskuline_accusative_determiner);
			case "f":
				return context.getString(R.string.feminine_accusative_determiner);
			case "n":
				return context.getString(R.string.neutral_accusative_determiner);
			default:
				return null;
		}
	}
	...
	public static String gender2AccSufix(Context context, String gender)
	{
		...
		{
			case "m":
				return context.getString(R.string.maskuline_accusative_suffix);
			case "f":
				return context.getString(R.string.feminine_accusative_suffix);
			case "n":
				return context.getString(R.string.neutral_accusative_suffix);
			default:
				return null;
		}
	}
	 ...
	 * @throws IOException Wird geworfen, falls beim Lesen/Schreiben der Streams ein Fehler auftritt
	 */
