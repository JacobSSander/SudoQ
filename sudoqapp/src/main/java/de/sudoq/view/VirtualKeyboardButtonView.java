...
public class VirtualKeyboardButtonView extends View implements ObservableInput
{
	 ...
	 * @param symbol die interne Id des Symbols
	 * @throws IllegalArgumentException Wird geworfen, falls der übergebene Kontext null ist
	 */
	 ...
	 *
	 * @param motionEvent Das Event, das von der API generiert wird
	...
	/**
	 * Zeichnet den VirtualKeyboardButtonView inklusive dessen Symbol abhängig vom Status (an/aus).
	 *
	 * @param canvas Das Canvas Objekt auf das gezeichnet wird
	 * @throws IllegalArgumentException Wird geworfen, falls canvas null ist
	 */
	@Override
	...
	/**
	 * Fügt einen InputListener diesem VirtualKeyboardButtonView hinzu um ihn benachrichtigen zu können.
	 *
	 * @param listener Ein InputListener der bei interaktion mit diesem VirtualKeyboardButtonView benachricht wird
	 * @throws IllegalArgumentException Wird geworfen, falls listener null ist
	 */
	 ...
	 *
	 * @param listener Ein InputListener der vom VirtualKeyboardButtonView gelöst werden soll
	 */
