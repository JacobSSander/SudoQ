...
public class SudokuLayout extends RelativeLayout implements ObservableCellInteraction, ZoomableView
{
	...
	private void inflateSudoku()
	{
		...
		// In case highlighting of current row and col is activated, pass each pos its constraint-mates
	...
	/**
	 * Berechnet das aktuelle Spacing (gem. dem aktuellen ZoomFaktor) und gibt es zurück.
	 *
	...
	/**
	 * Berechnet das aktuelle obere Margin (gem. dem aktuellen ZoomFaktor) und gibt es zurück.
	 *
	...
	/**
	 * Berechnet das aktuelle linke Margin (gem. dem aktuellen ZoomFaktor) und gibt es zurück.
	 *
	 ...
	 *
	 * @param width Die Breite auf die optimiert werden soll
	 * @param height Die Höhe auf die optimiert werden soll
	 */
	 ...
	 *
	 * @param currentCellView die zu setzende SudokuCellView
	 */
