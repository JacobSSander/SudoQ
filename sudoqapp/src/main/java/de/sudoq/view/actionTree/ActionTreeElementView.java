...
public abstract class ActionTreeElementView extends View
{
	 ...
	 *
	 * @param context Der Kontekt, in dem die View angezeigt wird
	 * @param ate Das Element im Aktionsbaum, dass von diesem ActionTreeElementView dargestellt wird
	 ...
	 *
	 * @param canvas Das Canvas, das bemalt werden soll.
	 */
	 ...
	 *
	 * @param actionTreeNavListener der zu registrierende Listener
	 */
	 ...
	 *
	 * @param actionTreeNavListener der zu deregistrierende Listener
	 */
