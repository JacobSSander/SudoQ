...
public class BranchingLine extends View
{
	 ...
	 * @param fromX der x Wert der Startposition in Rasterkoordinaten des ActionTreeControllers
	 * @param fromY der y Wert der Startposition in Rasterkoordinaten des ActionTreeControllers
	 * @param toX der x Wert der Endposition in Rasterkoordinaten des ActionTreeControllers
	 * @param toY der y Wert der Endposition in Rasterkoordinaten des ActionTreeControllers
	 */
