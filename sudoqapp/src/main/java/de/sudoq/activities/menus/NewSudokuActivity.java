...
import de.sudoq.controller.menu.SudokuTypeOrder;
...
public class NewSudokuActivity extends SudoQCompatActivity
{
	...
	public void onResume()
	{
		...
		{
			//TODO shouldn't happen in the first place!
...
//			((Spinner) findViewById(R.id.spinner_sudokutype)).setSelection(wtl.indexOf(sudokuType));
	 ...
	 *
	 * @param type Typ des zu startenden Sudokus
	 */
	 ...
	 * wird nichts getan.
	 *
	 * @param difficulty Schwierigkeit des zu startenden Sudokus
	 */
