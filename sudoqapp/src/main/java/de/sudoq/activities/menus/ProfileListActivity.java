...
public class ProfileListActivity extends SudoQListActivity implements OnItemClickListener
{
	 ...
	 *
	 * @param savedInstanceState Der Zustand eines vorherigen Aufrufs dieser Activity
	 */
	@Override
	 ...
	 * anklickt.
	 *
	 * @param parent AdapterView auf welcher der Benutzer etwas angeklickt hat
	 * @param view Vom Benutzer angeklickte View
	 * @param position Position der View im Adapter
	 * @param id ID der ausgewählten View
	 */
